...
export const handler = async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
  ...
  try {
    ...
    // Get raw OpenAI response with correct model name
    ...
    console.log('Updated user message with chat_id:', rawResponse.id);
    ...
    console.log('Successfully stored AI message with metadata:', insertedMessage);
